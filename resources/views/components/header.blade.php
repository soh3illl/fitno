        ...
        <div class="app-container container-xxl d-flex align-items-stretch py-5 py-lg-0">
            ...
            <div class="app-navbar-item d-flex flex-stack flex-row-fluid">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex align-items-center d-lg-none ms-n2 me-1" title="مشاهده sidebar menu">
                    ...
                    <!--begin::Logo-->
                    <a href="../../demo28/dist/index.html" class="d-flex align-items-center me-2">
                ...
                <div
                            ...
                            <div class="menu-state-bg menu-extended overflow-hidden overflow-lg-visible"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo28/dist/index.html" class="menu-link active">
																		<span
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo28/dist/dashboards/ecommerce.html"
                                                       class="menu-link">
																		<span
                                                                            class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                                        ...
                                                        <span class="d-flex flex-column">
																			<span class="fs-6 fw-bold text-gray-800">تجارت الکترونیک</span>
																			<span class="fs-7 fw-semibold text-muted">گزارش های فروش</span>
																		</span>
                                                    </a>
                                                    <!--end:Menu link-->
                                                </div>
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo28/dist/dashboards/projects.html"
                                                       class="menu-link">
																		<span
                                                                            class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo28/dist/dashboards/online-courses.html"
                                                       class="menu-link">
																		<span
                                                                            class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo28/dist/dashboards/marketing.html"
                                                       class="menu-link">
																		<span
                                                                            class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo28/dist/dashboards/bidding.html"
                                                       class="menu-link">
																		<span
                                                                            class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo28/dist/dashboards/pos.html" class="menu-link">
																		<span
                                                                            class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo28/dist/dashboards/call-center.html"
                                                       class="menu-link">
																		<span
                                                                            class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
                                        ...
                                        <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mx-5">
                                            <div class="d-flex flex-column me-5">
                                                ...
                                                <div class="fs-7 fw-semibold text-muted">الگوی فرود صفحه با قیمت و موارد
                                                    دیگر
                                                </div>
                                            </div>
                                            <a href="../../demo28/dist/landing.html"
                                    ...
                                    <div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo28/dist/dashboards/logistics.html"
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo28/dist/dashboards/website-analytics.html"
                                               class="menu-link py-2">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo28/dist/dashboards/finance-performance.html"
                                               class="menu-link py-2">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo28/dist/dashboards/store-analytics.html"
                                               class="menu-link py-2">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo28/dist/dashboards/social.html" class="menu-link py-2">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo28/dist/dashboards/delivery.html" class="menu-link py-2">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo28/dist/dashboards/crypto.html" class="menu-link py-2">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo28/dist/dashboards/school.html" class="menu-link py-2">
                                        ...
                                        <div class="menu-item p-0 m-0">
                                            <!--begin:Menu link-->
                                            <a href="../../demo28/dist/dashboards/podcast.html" class="menu-link py-2">
                                    ...
                                    <ul class="nav nav-stretch nav-line-tabs fw-bold fs-6 p-0 p-lg-10 flex-nowrap flex-grow-1">
                                        ...
                                        <li class="nav-item mx-lg-1">
                                            <a class="nav-link py-3 py-lg-6 text-active-primary" href="#"
                                               data-bs-toggle="tab" data-bs-target="#kt_app_header_menu_pages_account">اکانت</a>
                                        </li>
                                        <!--end:Nav item-->
                                        <!--begin:Nav item-->
                                        <li class="nav-item mx-lg-1">
                                        ...
                                        <li class="nav-item mx-lg-1">
                                            <a class="nav-link py-3 py-lg-6 text-active-primary" href="#"
                                               data-bs-toggle="tab" data-bs-target="#kt_app_header_menu_pages_widgets">ابزارک</a>
                                        </li>
                                        <!--end:Nav item-->
                                    </ul>
                                </div>
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3 mb-6 mb-lg-0">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo28/dist/pages/user-profile/overview.html"
                                                               class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo28/dist/pages/user-profile/projects.html"
                                                               class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo28/dist/pages/user-profile/campaigns.html"
                                                               class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo28/dist/pages/user-profile/documents.html"
                                                               class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo28/dist/pages/user-profile/followers.html"
                                                               class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo28/dist/pages/user-profile/activity.html"
                                                               class="menu-link">
                                                    ...
                                                    <div class="col-lg-3 mb-6 mb-lg-0">
                                                        ...
                                                        <div class="mb-6">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/pages/about.html"
                                                                   class="menu-link">
                                                                    <span class="menu-title">درباره</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            </div>
                                                            <!--end:Menu item-->
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/pages/team.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/pages/contact.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/pages/licenses.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/pages/sitemap.html"
                                                                   class="menu-link">
                                                        ...
                                                        <div class="mb-0">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/pages/careers/list.html"
                                                                   class="menu-link">
                                                                    <span class="menu-title">مشاغل لیست</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            </div>
                                                            <!--end:Menu item-->
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/pages/careers/apply.html"
                                                                   class="menu-link">
                                                    ...
                                                    <div class="col-lg-3 mb-6 mb-lg-0">
                                                        ...
                                                        <div class="mb-6">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/pages/faq/classic.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/pages/faq/extended.html"
                                                                   class="menu-link">
                                                                    <span class="menu-title">اضافه شده</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            </div>
                                                            <!--end:Menu item-->
                                                        ...
                                                        <div class="mb-6">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/pages/blog/home.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/pages/blog/post.html"
                                                                   class="menu-link">
                                                                    <span class="menu-title">پست مقالات</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            </div>
                                                            <!--end:Menu item-->
                                                        ...
                                                        <div class="mb-0">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/pages/pricing/column.html"
                                                                   class="menu-link">
                                                                    <span class="menu-title">ستونی</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            </div>
                                                            <!--end:Menu item-->
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/pages/pricing/table.html"
                                                                   class="menu-link">
                                                    ...
                                                    <div class="col-lg-3 mb-6 mb-lg-0">
                                                        ...
                                                        <div class="mb-0">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/pages/social/feeds.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/pages/social/activity.html"
                                                                   class="menu-link">
                                                                    <span class="menu-title">فعالیت</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/pages/social/followers.html"
                                                                   class="menu-link">
                                                                    <span class="menu-title">فالوورها</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/pages/social/settings.html"
                                                                   class="menu-link">
                                            ...
                                            <div class="col-lg-5 mb-6 mb-lg-0">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo28/dist/account/overview.html"
                                                               class="menu-link">
                                                                <span class="menu-title">بررسی اجمالی</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo28/dist/account/settings.html"
                                                               class="menu-link">
                                                                <span class="menu-title">تنظیمات</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo28/dist/account/security.html"
                                                               class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo28/dist/account/activity.html"
                                                               class="menu-link">
                                                                <span class="menu-title">فعالیت</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo28/dist/account/billing.html"
                                                               class="menu-link">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo28/dist/account/statements.html"
                                                               class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo28/dist/account/referrals.html"
                                                               class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo28/dist/account/api-keys.html"
                                                               class="menu-link">
                                                        ...
                                                        <div class="menu-item p-0 m-0">
                                                            <!--begin:Menu link-->
                                                            <a href="../../demo28/dist/account/logs.html"
                                                               class="menu-link">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 mb-6 mb-lg-0">
                                                ...
                                                <div class="mb-6">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/layouts/corporate/sign-in.html"
                                                           class="menu-link">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/layouts/corporate/sign-up.html"
                                                           class="menu-link">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/layouts/corporate/two-steps.html"
                                                           class="menu-link">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/layouts/corporate/reset-password.html"
                                                           class="menu-link">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/layouts/corporate/new-password.html"
                                                           class="menu-link">
                                                ...
                                                <div class="mb-0">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/layouts/overlay/sign-in.html"
                                                           class="menu-link">
                                                            <span class="menu-title">ورود</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/layouts/overlay/sign-up.html"
                                                           class="menu-link">
                                                            <span class="menu-title">ثبت نام</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/layouts/overlay/two-steps.html"
                                                           class="menu-link">
                                                            <span class="menu-title">دو مرحله ای</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/layouts/overlay/reset-password.html"
                                                           class="menu-link">
                                                            <span class="menu-title">ریست کلمه عبور</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/layouts/overlay/new-password.html"
                                                           class="menu-link">
                                                            <span class="menu-title">کلمه عبور جدید</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                            ...
                                            <div class="col-lg-3 mb-6 mb-lg-0">
                                                ...
                                                <div class="mb-6">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/layouts/creative/sign-in.html"
                                                           class="menu-link">
                                                            <span class="menu-title">ورود</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/layouts/creative/sign-up.html"
                                                           class="menu-link">
                                                            <span class="menu-title">ثبت نام</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/layouts/creative/two-steps.html"
                                                           class="menu-link">
                                                            <span class="menu-title">دو مرحله ای</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/layouts/creative/reset-password.html"
                                                           class="menu-link">
                                                            <span class="menu-title">ریست کلمه عبور</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/layouts/creative/new-password.html"
                                                           class="menu-link">
                                                            <span class="menu-title">کلمه عبور جدید</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                ...
                                                <div class="mb-6">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/layouts/fancy/sign-in.html"
                                                           class="menu-link">
                                                            <span class="menu-title">ورود</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/layouts/fancy/sign-up.html"
                                                           class="menu-link">
                                                            <span class="menu-title">ثبت نام</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/layouts/fancy/two-steps.html"
                                                           class="menu-link">
                                                            <span class="menu-title">دو مرحله ای</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/layouts/fancy/reset-password.html"
                                                           class="menu-link">
                                                            <span class="menu-title">ریست کلمه عبور</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/layouts/fancy/new-password.html"
                                                           class="menu-link">
                                                            <span class="menu-title">کلمه عبور جدید</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                            ...
                                            <div class="col-lg-3 mb-6 mb-lg-0">
                                                ...
                                                <div class="mb-0">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/extended/multi-steps-sign-up.html"
                                                           class="menu-link">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/extended/two-factor-auth.html"
                                                           class="menu-link">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/general/welcome.html"
                                                           class="menu-link">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/general/verify-email.html"
                                                           class="menu-link">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/extended/coming-soon.html"
                                                           class="menu-link">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/general/password-confirmation.html"
                                                           class="menu-link">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/general/account-deactivated.html"
                                                           class="menu-link">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/general/error-404.html"
                                                           class="menu-link">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/general/error-500.html"
                                                           class="menu-link">
                                            ...
                                            <div class="col-lg-3 mb-6 mb-lg-0">
                                                ...
                                                <div class="mb-0">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/email/welcome-message.html"
                                                           class="menu-link">
                                                            <span class="menu-title">پیام خوش امد گویی</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/email/reset-password.html"
                                                           class="menu-link">
                                                            <span class="menu-title">ریست کلمه عبور</span>
                                                        </a>
                                                        <!--end:Menu link-->
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/email/subscription-confirmed.html"
                                                           class="menu-link">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/email/card-declined.html"
                                                           class="menu-link">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/email/promo-1.html"
                                                           class="menu-link">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/email/promo-2.html"
                                                           class="menu-link">
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="../../demo28/dist/authentication/email/promo-3.html"
                                                           class="menu-link">
                                            ...
                                            <div class="col-lg-7">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 mb-6 mb-lg-0">
                                                        ...
                                                        <div class="mb-0">
                                                            <!--begin:Menu heading-->
                                                            <h4 class="fs-6 fs-lg-4 fw-bold mb-3 ms-4">عمومی مودال
                                                                ها</h4>
                                                            <!--end:Menu heading-->
                                                            <!--begin:Menu item-->
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/modals/general/invite-friends.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/modals/general/view-users.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/modals/general/select-users.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/modals/general/upgrade-plan.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/modals/general/share-earn.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/modals/forms/new-target.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/modals/forms/new-card.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/modals/forms/new-address.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/modals/forms/create-api-key.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/modals/forms/bidding.html"
                                                                   class="menu-link">
                                                    ...
                                                    <div class="col-lg-4 mb-6 mb-lg-0">
                                                        ...
                                                        <div class="mb-6">
                                                            <!--begin:Menu heading-->
                                                            <h4 class="fs-6 fs-lg-4 fw-bold mb-3 ms-4">پیشرفته مودال
                                                                ها</h4>
                                                            <!--end:Menu heading-->
                                                            <!--begin:Menu item-->
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/modals/wizards/create-app.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/modals/wizards/create-campaign.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/modals/wizards/create-account.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/modals/wizards/create-project.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/modals/wizards/top-up-wallet.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/modals/wizards/offer-a-deal.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/modals/wizards/two-factor-authentication.html"
                                                                   class="menu-link">
                                                                    <span
                                                                        class="menu-title">احراز هویت دومرحله ای</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            </div>
                                                            <!--end:Menu item-->
                                                        ...
                                                        <div class="mb-0">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/search/horizontal.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/search/vertical.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/modals/search/users.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/modals/search/select-location.html"
                                                                   class="menu-link">
                                                    ...
                                                    <div class="col-lg-4 mb-6 mb-lg-0">
                                                        ...
                                                        <div class="mb-0">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/wizards/horizontal.html"
                                                                   class="menu-link">
                                                                    <span class="menu-title">افقی</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/wizards/vertical.html"
                                                                   class="menu-link">
                                                                    <span class="menu-title">عمودی</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/wizards/two-factor-authentication.html"
                                                                   class="menu-link">
                                                                    <span
                                                                        class="menu-title">احراز هویت دومرحله ای</span>
                                                                </a>
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/wizards/create-app.html"
                                                                   class="menu-link">
                                                                    <span class="menu-title">ساختن اپ</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/wizards/create-campaign.html"
                                                                   class="menu-link">
                                                                    <span class="menu-title">ساختن کمپین</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/wizards/create-account.html"
                                                                   class="menu-link">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/wizards/create-project.html"
                                                                   class="menu-link">
                                                                    <span class="menu-title">ساختن پروژه</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="../../demo28/dist/utilities/wizards/offer-a-deal.html"
                                                                   class="menu-link">
                                                                    <span class="menu-title">پیشنهاد معامله</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                    ...
                                    <div class="tab-pane w-lg-500px" id="kt_app_header_menu_pages_widgets">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 mb-6 mb-lg-0">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo28/dist/widgets/lists.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo28/dist/widgets/statistics.html"
                                                       class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo28/dist/widgets/charts.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo28/dist/widgets/mixed.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo28/dist/widgets/tables.html" class="menu-link">
                                                ...
                                                <div class="menu-item p-0 m-0">
                                                    <!--begin:Menu link-->
                                                    <a href="../../demo28/dist/widgets/feeds.html" class="menu-link">
                                                        <span class="menu-title">تغذیه</span>
                                                    </a>
                                                    <!--end:Menu link-->
                                                </div>
                        ...
                        <div
                            ...
                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                ...
                                <div
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3" href="../../demo28/dist/apps/projects/list.html">
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3" href="../../demo28/dist/apps/projects/project.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                            <span class="menu-title">نمایش پروژه ها</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3" href="../../demo28/dist/apps/projects/targets.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3" href="../../demo28/dist/apps/projects/budget.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3" href="../../demo28/dist/apps/projects/users.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                            <span class="menu-title">کاربران</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3" href="../../demo28/dist/apps/projects/files.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3" href="../../demo28/dist/apps/projects/activity.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                            <span class="menu-title">فعالیت</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3" href="../../demo28/dist/apps/projects/settings.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                            <span class="menu-title">تنظیمات</span>
                            ...
                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                ...
                                <div
                                        ...
                                        <div
                                            ...
                                            <div class="menu-item">
                                                ...
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/ecommerce/catalog/products.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/ecommerce/catalog/categories.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/ecommerce/catalog/add-product.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/ecommerce/catalog/edit-product.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                                    <span class="menu-title"> محصولات</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/ecommerce/catalog/add-category.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/ecommerce/catalog/edit-category.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                    ...
                                    <div data-kt-menu-trigger="click"
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/ecommerce/sales/listing.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/ecommerce/sales/details.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/ecommerce/sales/add-order.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/ecommerce/sales/edit-order.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                    ...
                                    <div data-kt-menu-trigger="click"
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/ecommerce/customers/listing.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/ecommerce/customers/details.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                    ...
                                    <div data-kt-menu-trigger="click"
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/ecommerce/reports/view.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/ecommerce/reports/sales.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                                    <span class="menu-title">فروش</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/ecommerce/reports/returns.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/ecommerce/reports/customer-orders.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/ecommerce/reports/shipping.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3" href="../../demo28/dist/apps/ecommerce/settings.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                            <span class="menu-title">تنظیمات</span>
                            ...
                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                ...
                                <div
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3"
                                           href="../../demo28/dist/apps/support-center/overview.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                            <span class="menu-title">بررسی اجمالی</span>
                                    ...
                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                        ...
                                        <div
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/support-center/tickets/list.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/support-center/tickets/view.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                    ...
                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                        ...
                                        <div
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/support-center/tutorials/list.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/support-center/tutorials/post.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3" href="../../demo28/dist/apps/support-center/faq.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3"
                                           href="../../demo28/dist/apps/support-center/licenses.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                            <span class="menu-title">لاینسس شده</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3"
                                           href="../../demo28/dist/apps/support-center/contact.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                            <span class="menu-title">تماس با ما</span>
                            ...
                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                ...
                                <div
                                    ...
                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                        ...
                                        <div
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/user-management/users/list.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/user-management/users/view.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                    ...
                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                        ...
                                        <div
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/user-management/roles/list.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/user-management/roles/view.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3"
                                           href="../../demo28/dist/apps/user-management/permissions.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                            ...
                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                ...
                                <div
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3"
                                           href="../../demo28/dist/apps/contacts/getting-started.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3"
                                           href="../../demo28/dist/apps/contacts/add-contact.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                            <span class="menu-title"> افزودن تماس با ما</span>
                                        </a>
                                        <!--end:Menu link-->
                                    </div>
                                    <!--end:Menu item-->
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3"
                                           href="../../demo28/dist/apps/contacts/edit-contact.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                            <span class="menu-title"> تماس با ما</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3"
                                           href="../../demo28/dist/apps/contacts/view-contact.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                            ...
                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                ...
                                <div
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3"
                                           href="../../demo28/dist/apps/subscriptions/getting-started.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                            <span class="menu-title">شروع شدن</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3" href="../../demo28/dist/apps/subscriptions/list.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3" href="../../demo28/dist/apps/subscriptions/add.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3" href="../../demo28/dist/apps/subscriptions/view.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                            ...
                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                ...
                                <div
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3"
                                           href="../../demo28/dist/apps/customers/getting-started.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                            <span class="menu-title">شروع شدن</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3" href="../../demo28/dist/apps/customers/list.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                            <span class="menu-title">لیست مشتریان</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3" href="../../demo28/dist/apps/customers/view.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                            ...
                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                ...
                                <div
                                    ...
                                    <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                        ...
                                        <div
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/invoices/view/invoice-1.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/invoices/view/invoice-2.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                            ...
                                            <div class="menu-item">
                                                <!--begin:Menu link-->
                                                <a class="menu-link py-3"
                                                   href="../../demo28/dist/apps/invoices/view/invoice-3.html">
																	<span class="menu-bullet">
																		<span class="bullet bullet-dot"></span>
																	</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3" href="../../demo28/dist/apps/invoices/create.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                            ...
                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                ...
                                <div
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3"
                                           href="../../demo28/dist/apps/file-manager/folders.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3" href="../../demo28/dist/apps/file-manager/files.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                            <span class="menu-title">فایل ها</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3" href="../../demo28/dist/apps/file-manager/blank.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3"
                                           href="../../demo28/dist/apps/file-manager/settings.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                            <span class="menu-title">تنظیمات</span>
                            ...
                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                ...
                                <div
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3" href="../../demo28/dist/apps/inbox/listing.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3" href="../../demo28/dist/apps/inbox/compose.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3" href="../../demo28/dist/apps/inbox/reply.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                            ...
                            <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                ...
                                <div
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3" href="../../demo28/dist/apps/chat/private.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3" href="../../demo28/dist/apps/chat/group.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                                    ...
                                    <div class="menu-item">
                                        <!--begin:Menu link-->
                                        <a class="menu-link py-3" href="../../demo28/dist/apps/chat/drawer.html">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link py-3" href="../../demo28/dist/apps/calendar.html">
													<span class="menu-icon">
														<i class="bi bi-calendar3-event fs-3"></i>
													</span>
                            ...
                            <div class="menu-item">
                                ...
                                <a class="menu-link py-3"
                                   ...
                                   target="_blank">
                                    ...
                                    <span class="menu-title">تغییرات v8.1.6</span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                            <!--end:Menu item-->
                    ...
                    @can('is_admin')
                        ...
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-end"
                            ...
                            <!--begin:Menu link-->
                            <span class="menu-link py-3">
                            <a href="/admin/users" class="menu-title">کاربران</a>
                        </span>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                        ...
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-end"
                            ...
                            <!--begin:Menu link-->
                            <span class="menu-link py-3">
                            <a href="/admin/users" class="menu-title">مربیان</a>
                        </span>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                    ...
                    @can('is_coach')
                        ...
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-end"
                            ...
                            <!--begin:Menu link-->
                            <span class="menu-link py-3">
                            <a href="/coach/athletes" class="menu-title">شاگردان</a>
                        </span>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                        ...
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-end"
                            ...
                            <!--begin:Menu link-->
                            <span class="menu-link py-3">
                            <a href="/coach/programs" class="menu-title">برنامه ها</a>
                        </span>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                        ...
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-end"
                            ...
                            <!--begin:Menu link-->
                            <span class="menu-link py-3">
                            <a href="#" class="menu-title">سفارشات</a>
                        </span>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                        ...
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-end"
                            ...
                            <!--begin:Menu link-->
                            <span class="menu-link py-3">
                            <a href="/coach/message" class="menu-title">پیام</a>
                        </span>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
