                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                            ...
                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                ...
                                <!--begin::Add product-->
                                <a href="/coach/programs/create"
                                   class="btn btn-primary">افزودن برنامه</a>
                                <!--end::Add product-->
                            </div>
                            <!--end::کارت toolbar-->
                        </div>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5"
                                ...
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="win-w-100px">عنوان برنامه</th>
                                    <th class="win-w-200px">قیمت برنامه</th>
                                        ...
                                        <td>
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="/coach/programs/{{ $program->id }}/edit"
                                                       class="menu-link px-3">ویرایش</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <form action="/coach/programs/{{ $program->id }}" method="POST">
                                                        @method('DELETE')
                                                        @csrf
