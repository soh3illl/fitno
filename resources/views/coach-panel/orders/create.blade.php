    ...
    <div class="app-container container-xxl d-flex flex-row flex-column-fluid">
        ...
        <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                <!--begin::Form-->
                <form class="form d-flex flex-column flex-lg-row" action="/coach/orders/{{ $order->id }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        <!--begin::Main column-->
                                        ...
                                        <div class="card card-flush py-4">
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <div class="mb-10 fv-row">
                                                    <!--begin::Tags-->
                                                    <label class="required form-label">فایل</label>
                                                    <!--end::Tags-->
                                                    ...
                                                    <!--begin::توضیحات-->
                                                    @error('file_url')
                                                    <div class="text-danger fs-7">{{ $errors->first('file_url') }}</div>
                                                    @enderror
                                                    <!--end::توضیحات-->
