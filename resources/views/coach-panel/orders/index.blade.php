                        ...
                        <div class="card-body pt-0">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5"
                                ...
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="win-w-100px">مبلغ پرداختی</th>
                                    <th class="win-w-200px">برنامه</th>
                                ...
                                @foreach($orders as $order)
                                    ...
                                    <tr>
                                        ...
                                        <td class="pe-0">
                                            {{ $order->send == false ? 'در انتظار' : 'ارسال شده'}}
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="/coach/orders/create/{{ $order->id }}"
                                                       class="menu-link px-3">ارسال برنامه</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                {{--                                            <div class="menu-item px-3">--}}
