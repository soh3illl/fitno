            ...
            <div class="d-flex flex-column flex-column-fluid">
                ...
                <div id="kt_app_content" class="app-content flex-column-fluid">
                    <form class="form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework"
                          enctype="multipart/form-data" action="/admin/coaches/{{ $coach->id }}" method="POST">
                        @method('PUT')
                        @csrf
                        <!--begin::کناری column-->
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body text-center pt-0">
                                    ...
                                    <style>.image-input-placeholder {
                                            background-image: url({{ $coach->imagePath() }});
                                        }
                                    ...
                                    <div
                                        ...
                                        <span
                                            ...
                                            aria-label="حذف آواتار" data-bs-original-title="حذف آواتار"
                                            data-kt-initialized="1">
															<i class="bi bi-x fs-2"></i>
														</span>
                                        <!--end::حذف-->
                                    ...
                                    <!--end::Image input-->
                                    <!--begin::توضیحات-->
                                    <div class="text-muted fs-7">تصویر کوچک دسته را تنظیم کنید. فقط فایل های تصویری
                                        *.png، *.jpg و *.jpeg پذیرفته می شوند
                                    </div>
                                    <!--end::توضیحات-->
                                </div>
                                <!--end::کارت body-->
                        ...
                        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="name" class="form-control mb-2"
                                               placeholder="ناو نام خانوادگی مربی" value="{{ $coach->name }}">
                                        <!--end::Input-->
                                        <!--begin::توضیحات-->
                                        @error('name')
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="username" class="form-control mb-2"
                                               placeholder="نام کاربری" value="{{ $coach->username }}">
                                        <!--end::Input-->
                                        <!--begin::توضیحات-->
                                        @error('username')
                                    ...
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="phone" class="form-control mb-2"
                                               placeholder="شماره تماس" value="{{ $coach->phone }}">
                                        <!--end::Input-->
                                        <!--begin::توضیحات-->
                                        @error('phone')
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <select name="sex" class="form-control mb-2">
                                            <option value="مرد" {{ $coach->sex == 'مرد' ? 'selected' : '' }}>مرد</option>
                                            <option value="زن" {{ $coach->sex == 'زن' ? 'selected' : '' }}>زن</option>
                                        </select>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                ...
                                <div class="d-flex justify-content-end">
                                    <!--begin::Button-->
                                    <a href="/admin/coaches" id="kt_ecommerce_add_product_cancel"
