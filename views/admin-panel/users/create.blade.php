                                        ...
                                        <div class="card card-flush py-4">
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <div class="mb-10 fv-row">
                                                    ...
                                                    <!--end::Tags-->
                                                    <!--begin::Input-->
                                                    <input type="text" name="name" class="form-control mb-2" placeholder="نام" value="{{ old('name') }}" />
                                                    <!--end::Input-->
                                                    <!--begin::توضیحات-->
                                                    @error('name')
                                                ...
                                                <div class="mb-10 fv-row">
                                                    ...
                                                    <!--end::Tags-->
                                                    <!--begin::Input-->
                                                    <input type="password" name="password" class="form-control mb-2" placeholder="رمز عبور" value="{{ old('password') }}" />
                                                    <!--end::Input-->
                                                    <!--begin::توضیحات-->
                                                    @error('password')
